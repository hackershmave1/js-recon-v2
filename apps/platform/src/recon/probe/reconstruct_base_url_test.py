...
def test_prefix_rule_resolves_and_preserves_params():
    findings = [
        _view(
            "h1", "endpoint", "GET /address/search", {"method": "GET", "kind": "fetch"}, [_occ()]
        ),
        _view(
            "p1", "param", "GET /address/search query:page", {"location": "query", "name": "page"}
        ),
    ]
...
def test_collision_merges_relative_onto_absolute():
    findings = [
        ...
        _view(
            "pb",
            "param",
            "GET /location/address/search query:b",
            {"location": "query", "name": "b"},
        ),
    ]
...
def test_mixed_relative_absolute_group_is_not_rebased():
    ...
    findings = [
        _view(
            "hA", "endpoint", "GET /address/search", {"method": "GET", "kind": "fetch"}, [_occ()]
        ),
        _view(
            "hB",
            "endpoint",
